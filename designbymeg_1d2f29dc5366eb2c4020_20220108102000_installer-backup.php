...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'designbymeg_1d2f29dc5366eb2c4020_20220108102000_archive.zip';
	const ARCHIVE_SIZE		 = '116935896';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1d2f29d-08102000';
    const SECONDARY_PACKAGE_HASH = '65aaeef-08102000';
	const VERSION			 = '1.4.3';
